...
def dmonitoringd_thread(sm=None, pm=None):
  ...
  while True:
    ...
    if sm.updated['dragonConf']:
      print("dp_driver_monitor: %s" % sm['dragonConf'].dpDriverMonitor)
      print("dp_steering_monitor: %s" % sm['dragonConf'].dpSteeringMonitor)
      print("dp_steering_monitor_timer: %s" % sm['dragonConf'].dpSteeringMonitorTimer)
